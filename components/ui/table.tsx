...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cx(
      "border-t font-medium [&>tr]:last:border-b-0 bg-gray-800/50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cx(
      "h-12 px-4 text-left align-middle font-medium [&:has([role=checkbox])]:pr-0 text-gray-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cx("mt-4 text-sm text-gray-400", className)}
    {...props}
  />
));
